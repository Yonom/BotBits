...
namespace BotBits
{
    public static class BlockExtensions
    {
        ...
        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, ForegroundBlock block)
        {
            foreach (var item in blocks)
                item.Set(block);
        }

        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, BackgroundBlock block)
        {
            foreach (var item in blocks)
                item.Set(block);
        }

        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, Background.Id block)
        {
            blocks.Set(new BackgroundBlock(block));
        }

        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, Foreground.Id block)
        {
            blocks.Set(new ForegroundBlock(block));
        }

        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, Foreground.Id block, int goal)
        {
            blocks.Set(new ForegroundBlock(block, goal));
        }

        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, Foreground.Id block, uint args)
        {
            blocks.Set(new ForegroundBlock(block, args));
        }

        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, Foreground.Id block, string args)
        {
            blocks.Set(new ForegroundBlock(block, args));
        }

        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, Foreground.Id block, string text, string textColor)
        {
            blocks.Set(new ForegroundBlock(block, text, textColor));
        }

        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, Foreground.Id block, string text, Morph.Id signColor)
        {
            blocks.Set(new ForegroundBlock(block, text, signColor));
        }
        ...
        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, Foreground.Id block, Morph.Id morph)
        {
            blocks.Set(new ForegroundBlock(block, morph));
        }

        public static void Set(this IEnumerable<IEnumerable<BlocksItem>> blocks, Foreground.Id block, bool enabled)
        {
            blocks.Set(new ForegroundBlock(block, enabled));
        }
